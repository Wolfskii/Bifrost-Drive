...
Providers must stream large reads and writes, paginate listings, preserve TLS/SSH verification, and avoid advertising unsupported features. S3, SFTP, and WebDAV are implemented provider slices. SMB, FTP/FTPS, and additional cloud services are Planned.
