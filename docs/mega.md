...
The MEGA provider uses the official MEGA API client flow with client-side encryption support. The desktop wizard accepts a MEGA account email, password, and optional start path.
